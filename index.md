...
<div class="grid-container grid-2x2">
  ...
  <figure class="grid-item">
    ...
    <figcaption>"Partial Burrito Hold - No neck or head support."</figcaption>
  </figure>
 <figure class="grid-item">
...
<hr>
<h2>INTRODUCING THE PEDIATRIC POSITION HOLDER</h2>
<div style="display: flex; align-items: flex-start;">
  <div style="flex: 1; padding-right: 20px;">
    <p>Safety and customer care are of the foremost concerns in pediatric medical care, encompassing the well-being of the child, the parent or caregiver, and the healthcare provider. The Pediatric Position Holder (PPH) addresses a critical need in pediatric care by offering a standardized, gentle, and safe solution for pediatric medical positioning.</p>
    <p>Hospitals and insurance companies place immense value on safety as it directly impacts patient outcomes, hospital ratings, and financial relationships. The PPH ensures that millions of everyday procedures, performed annually, are safer for all involved.</p>
    <p>By reducing the need for manual restraint and minimizing the risk of bruising or injury, The Holder enhances the safety of medical procedures. The device's design respects the autonomy of young patients, reduces their distress, and ensures a more controlled and calm experience during medical interventions.</p>
  </div>
  <div>
...
<div class="grid-container grid-3x2">
  ...
  <figure class="grid-item">
    <img src="/images/product-assessment/PPH-illustration3.jpeg" alt="A Two Arm Hold">
...
**INSTRUCTIONS FOR USING THE PEDIATRIC POSITION HOLDER**
  ...
  4. **Adjust for Optimal Hold**: The holder is versatile and minimally invasive. Secure only the necessary extremities, whether it is one arm or all four extremities, based on the procedural requirements.
...
<div class="grid-container grid-2x2">
  ...
  <figure class="grid-item">
    <img src="/images/IMG_4536.jpg" alt="Technologist's hand captured in the direct x-ray beam during a voiding cystourethrogram.">
...
<div class="grid-container grid-2x2">
  ...
  <figure class="grid-item">
    ...
    <figcaption>"We were both apprehensive, I was worried that I'd have to hold her down with my hands. She wasn't bothered at all about this and I didnt feel guilty. I've heard some stories!"<p>Mom of 10 month old from Levelland, Tx</p></figcaption>
  </figure>
</div>
...
<div class="grid-container grid-2x2">
  <figure class="grid-item">
    <img src="/images/product-assessment/Tech-testimonial.jpeg" alt="">
...
<div class="grid-container grid-2x2">
  <figure class="grid-item">
    <img src="/images/Photoroom_20240811_184423.jpeg" alt="">
    <figcaption>This young child would not give it back to us.</figcaption>
  </figure>
  <figure class="grid-item">
    <img src="/images/Photoroom_20240811_184322.jpeg" alt="">
